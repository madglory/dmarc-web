...
class XMLReportUploader < CarrierWave::Uploader::Base
  ...
  def validate
    # Load required files
    doc   = Nokogiri::XML(File.read('doc/report_sample_yahoo.xml'))
    ...
    #Rails.logger.info "The file is " + errors.collect{|e| e.message}
